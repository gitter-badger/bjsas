...
@section('content')
	<div class="main-container container-fluid">
		<div class="page-container">
			@include( 'includes.sidebar', array('fieldActive'=>'Employees', 'subfield'=>'cashadvance') )

			<div class="page-content">
				@include( 'includes.breadcrumbs', array('crumbs'=>'Employee', 'subcrumbs'=>'Cash Advances') )
							...
							<div class="row no-margin ">
								...
								@if( Auth::User()->getAcl() === 'Admin' )
									<div class="buttons-preview pull-right">
										<div class="btn btn-blue shiny border-white animate bounceIn" ng-click="showContent( '/bjsAssets/partials/addCashAdvance.html' )" btn-hide="closeTemplate">Cash Advance</div>
									</div>
								@endif
								...
								<div class="col-xs-12">
									<div class="widget">
										<div class="widget-header bordered-bottom bordered-themesecondary">
											...
											<span class="widget-caption themesecondary">List of Cash Advances</span>
										</div>
