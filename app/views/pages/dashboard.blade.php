...
@stop
@section( 'navigator' )
    <nav role="navigation" class="navbar topnavbar topnavbar-blue navbar-fixed-top">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar">
                <span class="menu">menu</span>
            </button>
            <a href="http://www.bjsmotoshop.com" class="navbar-brand">
                <small>BJS MotoShop</small>
            </a>
        </div>
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <div class="message">
                                        ...
                                        <span class="message-subject">
                                            Bing Newsletter: The January Issue&rlm;
                                        </span>
                                        <span class="message-body">
                    ...
                    <li>
                        <a class="login-area dropdown-toggle" data-toggle="dropdown">
                            <div class="avatar" title="View your public profile">
                                <img src="bjsAssets/images/adam-jansen.jpg">
                            </div>
                            <section>
                                <h2><span class="profile"><span>{{ Auth::user()->getAuthUserName() }}</span></span></h2>
                            </section>
                        </a>
                        <!--Login Area Dropdown-->
                        <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                            ...
                            <li>
                                <div class="avatar-area">
                                    <img src="bjsAssets/images/adam-jansen.jpg" class="avatar">
